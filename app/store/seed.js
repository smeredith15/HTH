...
export const SEED_LISTINGS = withSeedDate([
  ...
  { id: 'lst-surf-van', title: "Surf Van Wall Art, Vintage Camper Beach Print on Wood, Coastal Van Life Decor, Retro Surfer Gift, Boho Beach House Art", tags: ["surf van wall art", "van life decor", "beach wall art", "coastal wall decor", "surfer gift", "vintage van art", "camper van art", "hippie wall art", "boho beach decor", "wood burning art", "pyrography print", "surf shack decor", "retro van art"], artwork_id: 'surf-van', channel: 'etsy', etsy_listing_id: '1884246466', etsy_url: 'https://www.etsy.com/listing/1884246466', listing_type: 'print', print_substrate: 'mdf', print_process: 'unknown', status: 'active', suppression_suspected: true, variants: [{ label: '12 × 12', width_in: 12, height_in: 12, shape: 'square', price: 80 }, { label: 'round', shape: 'round', price: 80 }] },
  { id: 'lst-cactus-skull', title: "Cow Skull Wall Art, Western Desert Cactus Print on Wood, Southwestern Boho Decor, Longhorn Skull Rustic Ranch Art", tags: ["cow skull wall art", "steer skull decor", "western wall art", "boho desert decor", "cactus wall art", "southwestern decor", "longhorn skull art", "rustic wall art", "wood burning art", "desert wall art", "ranch house decor", "western gift", "pyrography print"], artwork_id: 'western-cactus-longhorn-skull', channel: 'etsy', etsy_listing_id: '1759413854', etsy_url: 'https://www.etsy.com/listing/1759413854', listing_type: 'print', print_substrate: 'mdf', print_process: 'unknown', status: 'active', suppression_suspected: false, variants: [{ label: '12 × 8', width_in: 12, height_in: 8, shape: 'rect', price: 55 }, { label: '18 × 12', width_in: 18, height_in: 12, shape: 'rect', price: 75 }, { label: '24 × 16', width_in: 24, height_in: 16, shape: 'rect', price: 140 }] },
